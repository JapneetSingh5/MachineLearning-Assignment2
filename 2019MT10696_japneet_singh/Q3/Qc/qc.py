...
# for latest output and accuracies,  see c.txt 
...
def confusion_matrix_cvxopt():
    ...
    print("confusion matrix for cvxopt displayed and saved")
    plt.show()


def sklearn_gaussian_confusion_matrix():
    path_train_data ,path_test_data= process_command()
    train_data_file = path_train_data+ "/train_data.pickle"
    test_data_file = path_test_data+ "/test_data.pickle"
    train_data_file_loaded = pickle.load(open(train_data_file,"rb"))
    ...
    print("Confusion  Matrix for sklearn part displayed and saved")
    plt.show()
    count = 0
    for imagearr in mis_2_to_4:
        plt.imshow(imagearr)
        plt.savefig("2to4_"+str(count)+".png")
        count+=1
    for imagearr in mis_4_to_2:
        plt.imshow(imagearr)
        plt.savefig("4to2_"+str(count)+".png")
        count+=1
    print("Misclassified vectors - ")
    print(mis_2_to_4)
    print(mis_4_to_2)
...
if __name__ == "__main__":
    sklearn_gaussian_confusion_matrix()
    confusion_matrix_cvxopt()