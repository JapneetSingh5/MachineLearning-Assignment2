...
#for latest accuracies and output, see c.txt
...
def build_confusion_matrix(actual_p_predicted_p, actual_n_predicted_p, actual_p_predicted_n, actual_n_predicted_n,name):
    ...
    print("Confusion Matrix " + name, matrix)
...
def part1a():
    ...
    print("Test Set Accuracy for 1a: ", accuracy) 
    precision = (actual_p_predicted_p/(actual_p_predicted_p + actual_n_predicted_p));
    print("Test Set Precision for 1a: ", precision)
    recall =  (actual_p_predicted_p/(actual_p_predicted_p + actual_p_predicted_n));
    print("Test Set Recall for 1a: ", recall)
    f1 = 2*precision*recall/(precision+recall)
    print("Test Set F1 for 1a: ", f1)
    build_confusion_matrix(actual_p_predicted_p, actual_n_predicted_p, actual_p_predicted_n, actual_n_predicted_n, "1a")     
